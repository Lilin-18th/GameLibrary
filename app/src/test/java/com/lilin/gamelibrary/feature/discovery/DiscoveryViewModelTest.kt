...
class DiscoveryViewModelTest {
    ...
    @Test
    fun `retryTrendingGames should set loading state, call use case, and update to success`() =
        runTest {
            coEvery {
    ...
    @Test
    fun `retryTrendingGames should update state to error when use case fails`() = runTest {
        val exception = Exception("Network error")
        coEvery { mockGetTrendingGamesUseCase(any(), any()) } returns Result.failure(exception)
    ...
    @Test
    fun `retryHighlyRatedGames should set loading state, call use case, and update to success`() =
        runTest {
            coEvery {
                mockGetTrendingGamesUseCase(any(), any())
            } returns Result.success(mockGamesList)
    ...
    @Test
    fun `retryHighlyRatedGames should update state to error when use case fails`() = runTest {
        val exception = Exception("Network error")
        coEvery { mockGetTrendingGamesUseCase(any(), any()) } returns Result.success(listOf())
        coEvery { mockGetHighRatedGamesUseCase(any(), any()) } returns Result.failure(exception)
        coEvery { mockGetNewReleasesUseCase(any(), any()) } returns Result.success(listOf())
    ...
    @Test
    fun `retryNewReleases should set loading state, call use case, and update to success`() =
        runTest {
            coEvery {
                mockGetHighRatedGamesUseCase(any(), any())
            } returns Result.success(mockGamesList)
    ...
    @Test
    fun `reloadTrendingGames should update state to error when use case fails`() = runTest {
        val exception = Exception("Network error")
        coEvery { mockGetTrendingGamesUseCase(any(), any()) } returns Result.success(listOf())
        coEvery { mockGetHighRatedGamesUseCase(any(), any()) } returns Result.failure(exception)
        coEvery { mockGetNewReleasesUseCase(any(), any()) } returns Result.success(listOf())
    ...
    @Test
    fun `reloadTrendingGames current state is Success should set reloading state, call use case, and update to success`() =
        runTest {
            coEvery {
                mockGetHighRatedGamesUseCase(any(), any())
            } returns Result.success(mockGamesList)
    ...
    @Test
    fun `reloadHighlyRatedGames current state is Success should set reloading state, call use case, and update to success`() =
        runTest {
            coEvery {
                mockGetHighRatedGamesUseCase(any(), any())
            } returns Result.success(mockGamesList)
    ...
    @Test
    fun `reloadNewReleases current state is Success should set reloading state, call use case, and update to success`() =
        runTest {
            coEvery {
                mockGetHighRatedGamesUseCase(any(), any())
            } returns Result.success(mockGamesList)
    ...
    fun `reloadNewReleases current state is Error should set loading state, not call use case`() =
        runTest {
            ...
            coEvery { mockGetTrendingGamesUseCase(any(), any()) } returns Result.success(listOf())
            coEvery { mockGetHighRatedGamesUseCase(any(), any()) } returns Result.success(listOf())
            coEvery { mockGetNewReleasesUseCase(any(), any()) } returns Result.failure(exception)
